...
const Footer = ({
  ...
  // Set default values only if props are not provided
  const finalCompanyName = companyName || "HSCODES PRIVATE LIMITED";
  ...
  const finalContactInfo = {
    email: "info@hscodes.com",
    email2: "Hscodes.com@gmail.com",
    phone: "+91 8008002528",
    address: "HIG-135, Flat no 201,  Sri godha Nilayam, VI phase, K.P.H.B.Colony, Kukatpally,Hyderabad-500072. Telangana State , INDIA",
  };
  ...
  const finalFooterLinks = footerLinks || {
    "Customer support": [
  ...
  const contactInfoArray = [
    {
      ...
      text: finalContactInfo.address,
      href: null,
    },
    {
      icon: HiOutlineMail,
      text: finalContactInfo.email,
      href: `mailto:${finalContactInfo.email}`,
    },
    {
      icon: HiOutlineMail,
      text: finalContactInfo.email2,
      href: `mailto:${finalContactInfo.email2}`,
    },
    {
      icon: HiOutlinePhone,
      text: finalContactInfo.phone,
      href: `tel:${finalContactInfo.phone.replace(/\s+/g, "")}`,
    },
    {
      icon: HiOutlineGlobe,
      text: "www.hscodes.com",
      href: "http://www.hscodes.com",
    },
  ];
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-6  gap-8 lg:gap-12">
              ...
              {contactInfoArray.map((contact, index) => {
                ...
                const content = (
                  <div className="flex items-center space-x-3 group">
                    <div className="min-w-8 min-h-8 rounded-full flex items-center justify-center transition-all duration-200 bg-gray-700 group-hover:bg-blue-500">
                      <IconComponent className="w-4 h-4 text-white" />
                    </div>
                    <span className="text-sm font-light text-gray-300 group-hover:text-white transition-colors duration-200">
                      {contact.text}
                    </span>
                  </div>
                );
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    ...
                    >
                      ...
                      <div className="flex flex-col">
                        <span className="text-xs text-gray-300 whitespace-nowrap">Download on the</span>
                        <span className="text-sm font-semibold text-white whitespace-nowrap">
                          App Store
                        </span>
                      </div>
          ...
          {/* Footer Links */}
          {Object.entries(finalFooterLinks).map(([category, links]) => (
