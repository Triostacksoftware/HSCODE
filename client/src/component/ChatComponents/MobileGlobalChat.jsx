...
const MobileGlobalChat = ({ user, refreshUser, setMainActiveTab }) => {
        ...
        <div className="p-3 sm:p-4 px-4 sm:px-5 border-b border-gray-200 bg-white">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-gray-800">
              {currentView === "chapters" && "Global Chats"}
              {currentView === "groups" &&
                selectedChapter &&
                `Chapter ${selectedChapter.chapter}: ${selectedChapter.name}`}
              {currentView === "groups" && !selectedChapter && "Global Chats"}
              ...
              <div className="flex items-center justify-center h-full p-4">
                <div className="text-center text-gray-500">
                  ...
                  <h3 className="text-base sm:text-lg font-medium mb-2">
                    Browse Global Chapters
                  </h3>
                  <p className="text-xs sm:text-sm">
                    Select a chapter to find global trading groups
                  </p>
                </div>
              </div>
            )}
...
export default MobileGlobalChat;
