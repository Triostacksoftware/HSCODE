      ...
      setGroups((prevGroups) =>
        prevGroups.map((group) =>
          group._id === groupToEdit._id
            ? { ...group, name: editFormData.name, heading: editFormData.heading }
            : group
        )
      );
                ...
                filteredSections.map((section) => (
                  ...
                  >
                    <div className="text-xs sm:text-sm grid font-medium">
                      ...
                      <span className="text-gray-400 text-xs truncate">{section.title}</span>
                    </div>
                  </div>
                ))
              ) : activeSection && !activeChapter ? (
                ...
                >
                  <div className="flex items-center justify-between">
                      <div className="flex items-end space-x-2 sm:space-x-3 min-w-0 flex-1">
                        <div className="w-7 h-7 sm:w-8 sm:h-8 lg:w-9 lg:h-9 rounded-full flex items-center justify-center flex-shrink-0 border border-gray-200">
                          {group.image ? (
                            <img
                              src={
                      ...
                      <div className="relative ml-2">
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            console.log("Three dots clicked for group:", group._id, "Current openMenu:", openMenu);
        ...
        <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center p-3 sm:p-4">
          <div className="bg-white rounded-lg w-full max-w-sm sm:max-w-md max-h-[90vh] overflow-hidden">
            <div className="p-3 sm:p-4 border-b border-gray-200">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900">Edit Group</h3>
            </div>
